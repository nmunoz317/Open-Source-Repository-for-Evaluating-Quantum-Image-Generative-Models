...
"""
    Implementation of the Denoising Diffusion Probabilistic architecture. The source code was extracted from [1].
...
class MyUNet(nn.Module):
    def __init__(self, n_steps=1000, time_emb_dim=100, img_size=32):
        ...
        self.b1 = nn.Sequential(
            MyBlock((1, img_size, img_size), 1, 10),
            MyBlock((10, img_size, img_size), 10, 10),
            MyBlock((10, img_size, img_size), 10, 10)
        )
        ...
        self.b2 = nn.Sequential(
            MyBlock((10, img_size//2, img_size//2), 10, 20),
            MyBlock((20, img_size//2, img_size//2), 20, 20),
            MyBlock((20, img_size//2, img_size//2), 20, 20)
        )
        ...
        self.b3 = nn.Sequential(
            MyBlock((20, img_size//4, img_size//4), 20, 40),
            MyBlock((40, img_size//4, img_size//4), 40, 40),
            MyBlock((40, img_size//4, img_size//4), 40, 40)
        )
        ...
        self.b_mid = nn.Sequential(
            MyBlock((40, img_size//8, img_size//8), 40, 20),
            MyBlock((20, img_size//8, img_size//8), 20, 20),
            MyBlock((20, img_size//8, img_size//8), 20, 40)
        )
        ...
        self.b4 = nn.Sequential(
            MyBlock((80, img_size//4, img_size//4), 80, 40),
            MyBlock((40, img_size//4, img_size//4), 40, 20),
            MyBlock((20, img_size//4, img_size//4), 20, 20)
        )

        self.up2 = nn.ConvTranspose2d(20, 20, 4, 2, 1)
        self.te5 = self._make_te(time_emb_dim, 40)
        self.b5 = nn.Sequential(
            MyBlock((40, img_size//2, img_size//2), 40, 20),
            MyBlock((20, img_size//2, img_size//2), 20, 10),
            MyBlock((10, img_size//2, img_size//2), 10, 10)
        )

        self.up3 = nn.ConvTranspose2d(10, 10, 4, 2, 1)
        self.te_out = self._make_te(time_emb_dim, 20)
        self.b_out = nn.Sequential(
            MyBlock((20, img_size, img_size), 20, 10),
            MyBlock((10, img_size, img_size), 10, 10),
            MyBlock((10, img_size, img_size), 10, 10, normalize=False)
        )
